...
export class BankrComputeAdapter implements ComputeProviderAdapter {
  ...
  async provision(request: ProvisionRequest): Promise<ProvisionResult> {
    return {
      ...
      message: 'Bankr provision adapter is scaffolded but not yet implemented.',
  ...
  async usage(request: UsageRequest): Promise<UsageResult> {
    return {
      ...
      provider: this.provider,
      usage: [],
      message: 'Bankr usage metering adapter is scaffolded but not yet implemented.',
  ...
  async terminate(request: TerminateRequest): Promise<TerminateResult> {
    return {
      ...
      provider: this.provider,
      terminated: false,
      message: 'Bankr terminate adapter is scaffolded but not yet implemented.',
